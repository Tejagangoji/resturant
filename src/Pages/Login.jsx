...
export default function Login() {
    ...
    const submitHnalder = (e) => {
        e.preventDefault();
        axios.post("https://resturantbackend-otgt.onrender.com/login", login).then(res => {localStorage.setItem("userid", res.data); return navigate('/')}).catch(err => toast(err.response.data));
    }
    return (
        <div className='login'>
